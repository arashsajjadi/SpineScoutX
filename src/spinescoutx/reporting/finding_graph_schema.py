"""Study-level non-diagnostic finding-graph schema (v4): build, validate, render.
...
and crop provenance. This module builds that dict, validates it (probabilities sum ≈ 1,
...
SCHEMA_VERSION = "finding_graph_v4"
DISCLAIMER = (
...
def render_markdown(graph: dict[str, Any]) -> str:
    ...
    for f in sorted(
        ...
        lines.append(
            ...
            f"{f['calibrated_confidence']} | {f['uncertainty_flag']} | "
